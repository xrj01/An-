...
import JDOverviewInfo from './JDOverviewInfo';
    ...
    */
    ...
    isShowModal(type, isTrue, record){
        this.setState({
            ...
            isTrue && this.logisticsModal.getIdAndLogiticsDetail(record)
        })
    }
    // 获取详情信息
    getDetails = (id) => {
    ...
    render() {
        ...
        return (
            <div className='parentOrder-main-box'>
                <h4 className='h4-title'>京东订单详情</h4>
                {
                ...
                <JDOverviewInfo ref={(ref) => { this.overviewInfo = ref }} />
