...
import './index.scss'
export default class commodityDetails extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            JD_img:[],  //  商品详情图片
    ...
    render(){
        ...
        return(
            <div className='commodity-details-box'>
                <h4 className='h4-title'>商品详情-京东</h4>
                {/* 基本信息 */}
                <div className='commodity-basicinfo'>
                    ...
                    <div className='commodity-basicinfo-content'>
                        ...
                        <Row>
                            <Col span={8}>
                                <span>京东价：</span>
                                <span>{JD_info.jd_price}</span>
                            </Col>
                            <Col span={8}>
                                <span>协议价：</span>
                                <span>{JD_info.anmro_price}</span>
                            </Col>
                        </Row>
                        <Row>
                            <Col span={8}>
